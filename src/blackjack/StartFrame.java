    ...
    public StartFrame() {
        ...
        ruleButton.addActionListener(e -> { //當"Rules"按鈕被點擊時觸發
            String gameRules = "遊戲規則：\n\n" +
                               ...
                               "3. 當玩家選擇抽牌(Hit)時，會獲得一張新的牌，如果還要可以繼續選擇抽牌(Hit)\n" +
                               "4. 當玩家選擇停牌(Stand)時，會進行總點數的結算，手牌總點數較高的一方贏得該局(如果沒人爆牌)\n" +
                               "5. 若任意一方手牌總點數超過21點，稱為「爆牌」，即立刻輸掉該局\n" +
                               "6. A可以視為1點或11點，J、Q、K算10點，其他牌為其數字\n" +
                               "7. 當莊家手牌總點數低於17點時需進行抽牌直到總點數達到或超過17點\n" +
                               "8. 玩家和莊家各有6個籌碼(Chips)，在每局剛開始時，可以押注1~3個籌碼，即為該局的賭注\n"+
                               "9. 當任意一方輸掉一局時，敗者失去賭注數字的籌碼，勝者獲得賭注數字的籌碼，平手則籌碼不變\n"+
                               "10. 當任意一方籌碼歸零，對方獲勝\n\n"
